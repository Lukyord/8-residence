...
<head>
    ...
    <title>8 Residence</title>
    <meta name="description" content="">
    <meta name="keywords" content="">
    <meta property="og:title" content="8 Residence">
    ...
    <link rel="mask-icon" href="<?php echo $root; ?>assets/img/favicon/safari-pinned-tab.svg" color="#D9B887">
...
<body>
    <div id="page" class="<?php if ($page == '404.php') {
        ...
        <header id="header">
            <div class="header-nav animate fadeInDown ease-out-cubic "
                data-wow-delay="0.5s"
                data-wow-duration="1.5s">
                <div class="header-register">
                    <a href="#register-form" class="button dark-bg link-scroll">
                        <span class="hidden-device-md">REGISTER</span>
                        <span class="show-md">REGISTRATION</span>
                    </a>
                </div>
                <div class="header-logo">
                    <?php include($root . "include/element-logo-svg.php"); ?>
                </div>
                <div class="header-call">
                    <i class="ic ic-call hidden-device-md size-icon-16 c-white"></i>
                    <a href="tel:+66910678949" class="button dark-bg">
                        <span class="hidden-device-md">CALL</span>
                        <span class="show-md">CALL 091-067-8949 </span>
                    </a>
                </div>
            </div>
        </header>